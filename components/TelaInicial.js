    ...
    return (
        <View style={ estilos.container }>
            ...
            <View style={estilos.boxBotoes}>
                <Pressable onPress={ () => {props.navigation.navigate("TelaGatos") } }
                ...
                <Pressable
                onPress={ () => {props.navigation.navigate("TelaCachorro") } }
                style={estilos.botaoContainer}
                >
                    <Text style={ estilos.botaoLabel}>Cachorros</Text>
                </Pressable>

                <Pressable
                onPress={ () => {props.navigation.navigate("TelaCoelhos") } }
                style={ estilos.botaoContainer }
                >
                    <Text style={estilos.botaoLabel}>Coelhos</Text>
                </Pressable>
            </View>
        </View>
    )
